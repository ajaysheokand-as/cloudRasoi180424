            ...
            <div class="card">
              ...
              <div class="card-body">
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  ...
                  <thead>
                  <tr role="row">
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column ascending">SNo.</th>
                  ...
                  <tr class="odd">
                    <td class="dtr-control"><?php echo $i; $i++; ?> </td>
                    <td class="sorting_1"><?php echo ("Permission Name"); ?></td>
                    <td  ><?php echo ("ON/OFF"); ?> </td>
                    <td  >
                    <div class="custom-control custom-switch">
              <!-- <label class="custom-control-label" for="">Category View</label> -->
              <input type="checkbox" class="custom-control-input" onchange="" id="permissionSwitch">
              <label class="custom-control-label" for="permissionSwitch"> </label>
            </div>
                    </td>
                    </tr>
