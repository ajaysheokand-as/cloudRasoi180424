                ...
                <div class="container">
                    <div class="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending"  >HSN Code</th> -->
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT a.orderid,a.name,a.bill_no,a.paid,a.order_type,a.tableid,a.date,b.title FROM orders a, dashboard b where a.restaurant = b.restaurant and b.id = a.tablegroup and a.restaurant = $restaurant and a.status = 1 and Date(a.date) = Date('$date') order by a.date desc";
                                                        $res = $con->query($sql);
