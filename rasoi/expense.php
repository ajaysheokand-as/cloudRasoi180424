...
<body class="layout-top-nav control-sidebar-slide-open" style="height: auto;">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Expense's </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">Home </a> / Expense</li>
                          ...
                          <tbody>
                            ...
                            ?>
                              ...
                              <tr class="odd">
                                ...
                                <td><button class="btn btn-danger" onclick="deleteExpense(<?php echo $row['id']; ?>,<?php echo $row['cat_id']; ?>);"><i class="fas fa-trash"> </i> Delete </button></td>
  ...
  <script>
    function deleteExpense(expense_id, category_id) {
      swal("Are You Sure", "Delete Expense permanently", "warning", {
          button: "Delete",
          dangerMode: true,
        ...
        .then((res) => {
          if (res) {
            $.ajax({
              url: constant.url + "expense/delete.php",
              method: "POST",
              data: JSON.stringify({
